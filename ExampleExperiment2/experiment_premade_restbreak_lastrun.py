...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Wed Feb  8 14:10:46 2017
...
expName = u'experiment_premade_restbreak'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/Rivendell/Documents/UWA/Psychopy_workshop/Example experiment2/experiment_premade_restbreak.psyexp',
...
text = visual.TextStim(win=win, ori=0, name='text',
    text=u"Well done! You're halfway through.\nPlease take a break!\nPress space to continue",    font=u'Arial',
    pos=[0, 0], height=0.1, wrapWidth=None,
...
practice_loop = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=u'/Users/Rivendell/Documents/UWA/Psychopy_workshop/Example experiment2/experiment_premade_restbreak.psyexp',
