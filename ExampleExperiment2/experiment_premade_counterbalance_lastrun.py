...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Wed Feb  8 13:36:59 2017
...
expName = u'experiment_premade_counterbalance'  # from the Builder filename that created this script
expInfo = {u'gender': u'', u'age': u'', u'session': u'001', u'participant': u'', u'Animal': u''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/Rivendell/Documents/UWA/Psychopy_workshop/Example experiment2/experiment_premade_counterbalance.psyexp',
...
practice_loop = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=u'/Users/Rivendell/Documents/UWA/Psychopy_workshop/Example experiment2/experiment_premade_counterbalance.psyexp',
    trialList=data.importConditions("practice_%s.xlsx" %(expInfo['Animal'])),
...
experiment_loop = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=u'/Users/Rivendell/Documents/UWA/Psychopy_workshop/Example experiment2/experiment_premade_counterbalance.psyexp',
    trialList=data.importConditions("%s.xlsx" %(expInfo['Animal'])),
