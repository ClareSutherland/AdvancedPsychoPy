...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Wed Feb  8 13:54:49 2017
...
expName = u'experiment_premade_random'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/Rivendell/Documents/UWA/Psychopy_workshop/Example experiment2/experiment_premade_random.psyexp',
...
#randomise a list of conditions
conditions = ["cat.xlsx", "duck.xlsx", "mouse.xlsx"]
shuffle(conditions)
#create a variable called ‘filename’ which grabs the first condition in this list
filename = conditions[0]
filename_prac = "practice_" + filename
...
practice_loop = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=u'/Users/Rivendell/Documents/UWA/Psychopy_workshop/Example experiment2/experiment_premade_random.psyexp',
    trialList=data.importConditions("%s" %(filename_prac)),
...
experiment_loop = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=u'/Users/Rivendell/Documents/UWA/Psychopy_workshop/Example experiment2/experiment_premade_random.psyexp',
    trialList=data.importConditions("%s" %(filename) ),
